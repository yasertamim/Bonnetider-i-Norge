...
import 'package:ninja_card/SelectAzkar.dart';
import 'package:ninja_card/azkar.dart';
import 'package:ninja_card/city_shared_preferance.dart';
import 'package:ninja_card/home.dart';
import 'package:ninja_card/tasbih.dart';
...
void main() async {
  ...
  await CitySharedPreferance.init();

  runApp(MaterialApp(
    debugShowCheckedModeBanner: false,
    // initialRoute determine which page should pop up once the app is running
    initialRoute: "/",
    // we use route to determine the way we should route between the pages
    routes: {
      "/": (context) => SplashScreen(),
      "/home": (context) => Prayer(),
      "/cities2": (context) => Cities2(),
      "/tasbih": (context) => TasbihScreen(),
      "/selectAzkar": (context) => SelectAzkar(),
      "/azkar": (context) => Azkar(),
      "/azkarMasa": (context) => AzkarMasa(),
      //    "/quibla": (context) => Quibla(),
...
//           // Show splash screen widget while waiting for app to initialize
//           return SplashWidget();
//         } else {
//           // App is initialized, show the main app widget
//           return MaterialApp(
//             debugShowCheckedModeBanner: false,
//             home: NinjaCard(),
//           );
